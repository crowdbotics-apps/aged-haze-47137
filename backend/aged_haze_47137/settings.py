"""
Django settings for aged_haze_47137 project.
...
ROOT_URLCONF = 'aged_haze_47137.urls'
...
WSGI_APPLICATION = 'aged_haze_47137.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_haze_47137 API",
    "DESCRIPTION": "API documentation for aged_haze_47137 App",
    "VERSION": "v1",
}
